...
// Make the query
$q = "INSERT INTO houses (ref_num, loctn, price, type, mini_descr, b_rooms, thumb, 
status) VALUES (' ', '$loctn', '$price', '$type', '$mini_descr', '$b_rooms', '$thumb', 
'$status' )";
...
<p class="error">The house could not be added due to a system error. We apologize 
...
<div id="rightcol">
<nav>
<?php include('includes/adminmenu.inc'); ?>
</nav>
</div>
<h2>Add a House</h2>
...
<p><label class="label" for="price"><b>Price:</b></label><input id="price" 
type="text" name="price" size="9" maxlength="9" 
...
<p><label class="label" for="thumb"><b>Thumbnail:</b></label><input id="thumb" 
type="text" name="thumb" size="45" maxlength="45" value="<?php if (isset($_POST['thumb'])) 
echo $_POST['thumb']; ?>"></p>
<p><label class="label"><b>Brief Description:</b></label><textarea name="mini_descr" 
...
<p><label class="label"><b>URL for Full Description:</b></label><input id="full_spec" 
type="text" name="full_spec" size="60" maxlength="60" 
...
<footer>
<p><a id="out" href="logout.php">[Log out]</a>Administrator change password.
   Click <a href="changepassword.php"> Here </a></p>
